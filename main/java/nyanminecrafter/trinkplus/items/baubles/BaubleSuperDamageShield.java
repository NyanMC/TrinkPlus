...
public class BaubleSuperDamageShield extends SuperDamageShield implements IBauble {
	
	private SuperDamageShieldSettings config = ModConfig.SERVER.S_SOH;
	
	public BaubleSuperDamageShield(String name) {
		super(name);
