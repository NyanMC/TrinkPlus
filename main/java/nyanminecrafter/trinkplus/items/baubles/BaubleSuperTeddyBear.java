...
public class BaubleSuperTeddyBear extends SuperTeddyBear implements IBauble {
	
	private SuperTeddyBearSettings config = ModConfig.SERVER.S_TB;
	
	public BaubleSuperTeddyBear(String name) {
		super(name);
